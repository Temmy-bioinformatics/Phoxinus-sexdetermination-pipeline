...
# #adding commands to install DNAcopy
if (!require("BiocManager", quietly = TRUE))
     install.packages("BiocManager", lib = "/home/toriowo/Tools/Resources/Rpackages", repos = "http://cran.us.r-project.org")
...
dev.copy(jpeg,wjpg)
dev.off()
plot(segment.smoothed.x.object, plot.type="s")
dev.copy(jpeg,wjpg)
dev.off()
